...
$spreadsheet->getActiveSheet()->setCellValue('D1', 'Nama Siswa');
$spreadsheet->getActiveSheet()->setCellValue('E1', 'Jenis Kelamin');
...
$spreadsheet->getActiveSheet()->setCellValue('I1', 'Tempat Lahir');
$spreadsheet->getActiveSheet()->setCellValue('J1', 'Tanggal Masuk');
$spreadsheet->getActiveSheet()->setCellValue('K1', 'Tanggal Keluar');
...
foreach ($DataMurid as $item) {
    ...
    $spreadsheet->getActiveSheet()->setCellValue('D' . $row, $item['NamaSiswa']);
    $spreadsheet->getActiveSheet()->setCellValue('E' . $row, $item['GenderSiswa']);
    $spreadsheet->getActiveSheet()->setCellValue('F' . $row, $item['AyahSiswa']);
    $spreadsheet->getActiveSheet()->setCellValue('G' . $row, $item['IbuSiswa']);
    $spreadsheet->getActiveSheet()->setCellValue('H' . $row, $item['TglLhrSiswa']);
    $spreadsheet->getActiveSheet()->setCellValue('I' . $row, $item['TmptLhrSiswa']);
    $spreadsheet->getActiveSheet()->setCellValue('J' . $row, $item['TGLMasuk']);
    $spreadsheet->getActiveSheet()->setCellValue('K' . $row, $item['TGLKeluar']);
    $spreadsheet->getActiveSheet()->setCellValue('L' . $row, $item['Status']);
    $row++;
    $no++;
}
}
