...
$pdf->setTitle('Laporan Pembayaran '.$NamaSiswa.' ('.$NisSiswa.')');
$pdf->setSubject($APPNAME[0]['NamaInstansi']);
$pdf->setKeywords('TCPDF, PDF, example, test, guide');

$customstring="by Bening Techno \n".$APPNAME[0]['Alamat']." Nomor HP : +".$APPNAME[0]['NomorWA'];
$logoPath = FCPATH . '/file/data/gambar/'.$APPNAME[0]['Logo']; // Sesuaikan dengan path logo Anda
$logoWidth = 50; // Ganti dengan lebar yang sesuai
$pdf->setHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'Laporan Pembayaran', $customstring);
