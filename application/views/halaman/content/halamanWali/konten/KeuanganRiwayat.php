                ...
                <div class="col-md-4">
                    <div class="background-effect">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <?= form_open(base_url('Wali_Halaman/RiwayatBayar'), array('method' => 'post')); ?>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        <input disabled type="checkbox" class="kelas-checkbox" name="bayar[]"
                                                            value="<?=$i.'/'.$key?>" <?php if ($DataCari!=='Data Kosong') { foreach ($DataCari as $tb3) { if ($tb3->BayarBulan==$i && $tb3->BayarTahun===$key){echo "checked";}}}?> >
                                                    </div>
                                                </td>
                                                <td><?= $key ?></td>
                                                <td><?= pasangbulan($i) ?></td>
