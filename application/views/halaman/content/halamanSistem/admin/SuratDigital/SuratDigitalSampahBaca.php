                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="<?=base_url('User_admin/SuratDigitalHapusPermanen/Permanen/'.$IDSurat)?>" class="btn btn-danger">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="modal fade" id="RestoreModal<?= $IDSurat ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                            <a href="<?=base_url('User_admin/SuratDigitalRestore/Restore/'.$IDSurat)?>" class="btn btn-primary">Kembalikan</a>
                          </div>
                        </div>
                      </div>
                    </div>