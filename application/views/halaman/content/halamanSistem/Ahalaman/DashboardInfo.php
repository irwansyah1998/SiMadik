...
// Medefinisikan Variabel data untuk di tampilkan
foreach ($DataSuratDigitalDetail as $SDB) {
  $IDSurat = $SDB->IDSurat;
              ...
              <div class="card card-primary card-outline shadow animate__animated animate__fadeInRight">
                  ...
                  <div class="card-footer">
                      <!-- Tombol alat atau aksi lainnya -->
                          <a href="<?=base_url('User_halaman/')?>" class="btn btn-secondary btn-block mb-3 shadow"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
                  </div>
              </div>
              <!-- /.card -->
            </div>
