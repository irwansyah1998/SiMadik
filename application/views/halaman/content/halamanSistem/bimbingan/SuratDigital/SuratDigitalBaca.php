              ...
              <div class="card shadow animate__animated animate__fadeInLeft">
                ...
                <div class="card-body p-0">
                  <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                      <a href="<?=base_url('User_bk/')?>SuratDigital" class="nav-link active">
                  ...
                  <div class="card-body p-0">
                      ...
                      <div class="mailbox-controls with-border text-center">
                          <div class="btn-group">
                              ...
                              <button type="button" data-toggle="modal" data-target="#EditModal<?= $IDSurat ?>" class="btn btn-default btn-sm" title="Edit">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="<?=base_url('User_bk/SuratDigitalCRUD/Hapus/'.$IDSurat)?>" class="btn btn-danger">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div class="modal fade" id="EditModal<?= $IDSurat ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="deleteModalLabel">Peringatan!</h5>
                          ...
                          <div class="modal-body">
                            Apakah Anda yakin ingin merubah surat ini?
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                            <a href="<?=base_url('User_bk/SuratDigital/Edit/'.$IDSurat)?>" class="btn btn-primary">Lanjutkan</a>
                          </div>
                        </div>
                      </div>
                    </div>