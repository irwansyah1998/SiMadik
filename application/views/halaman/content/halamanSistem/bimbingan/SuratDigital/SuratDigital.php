          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right animate__animated animate__fadeInRight">
                <li class="breadcrumb-item active">Terkirim</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="row">
            ...
            <div class="card shadow animate__animated animate__fadeInLeft">
              ...
              <div class="card-body p-0">
                <ul class="nav nav-pills flex-column">
                  ...
                  <li class="nav-item">
                    <a href="<?=base_url('User_bk/')?>SuratDigitalHapus" class="nav-link">
          ...
          <div class="col-md-9">
            ...
            <?= form_open_multipart(base_url('User_bk/SuratDigitalHapusMany'), array('method' => 'post','id' => 'deleteForm')); ?>
              <input type="hidden" name="Halaman" value="SuratDigital">
                        ...
                        <?php if ($SuratDigital!==false) {
                          ...
                          <tr>
                            ...
                            <td class="mailbox-name">
                              <a href="<?=base_url('User_bk/SuratDigital/Baca/'.$SD->IDSurat)?>">
                              <?=$SD->NamaGuru?>
                              </a></td>
