          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right animate__animated animate__fadeInRight">
                <li class="breadcrumb-item active">Rancangan</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <?= form_open_multipart(base_url('User_bk/SuratDigitalHapusMany'), array('method' => 'post','id' => 'deleteForm')); ?>
              <input type="hidden" name="Halaman" value="SuratDigitalDraft">
              <div class="card card-primary card-outline shadow animate__animated animate__fadeInRight">
                <div class="card-header">
                  <h3 class="card-title">Rancangan Surat</h3>
                        ...
                        <?php if ($SuratDigital!==false) {
                          ...
                          <tr>
                            ...
                            <td class="mailbox-name">
                              <a href="<?=base_url('User_bk/SuratDigitalDraft/Baca/'.$SD->IDSurat)?>">
                              <?=$SD->NamaGuru?>
                              </a>
                            </td>
