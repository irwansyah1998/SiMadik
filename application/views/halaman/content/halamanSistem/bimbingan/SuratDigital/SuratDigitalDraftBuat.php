  ...
  <?= form_open(base_url('User_bk/SuratDigitalDraftCRUD/Simpan')) ?>
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-3">
            <a href="<?=base_url('User_bk/')?>SuratDigitalBuat" class="btn btn-primary btn-block mb-3 shadow"><i class="fas fa-envelope-open-text"></i> Buat Rancangan Baru</a>
