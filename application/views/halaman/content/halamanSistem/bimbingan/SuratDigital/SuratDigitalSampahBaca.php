            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right animate__animated animate__fadeInRight">
                  <li class="breadcrumb-item active">Membaca Surat</li>
                  <li class="breadcrumb-item">Terhapus</li>
          ...
          <div class="row">
              ...
              <div class="card shadow animate__animated animate__fadeInLeft">
                ...
                <div class="card-body p-0">
                  <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                      <a href="<?=base_url('User_bk/')?>SuratDigitalHapus" class="nav-link active">
            ...
            <div class="col-md-9">
              <div class="card card-primary card-outline shadow">
                  <div class="card-header">
                      <h3 class="card-title">Membaca Surat</h3>
                      <div class="card-tools">
                  ...
                  <div class="card-body p-0">
                      ...
                      <div class="mailbox-controls with-border text-center">
                          <div class="btn-group">
                              ...
                              <button type="button" data-toggle="modal" data-target="#RestoreModal<?= $IDSurat ?>" class="btn btn-default btn-sm" title="Restore Data">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="<?=base_url('User_bk/SuratDigitalHapusPermanen/Permanen/'.$IDSurat)?>" class="btn btn-danger">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div class="modal fade" id="RestoreModal<?= $IDSurat ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                            Apakah Anda yakin ingin mengembalikan surat ini?
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                            <a href="<?=base_url('User_bk/SuratDigitalRestore/Restore/'.$IDSurat)?>" class="btn btn-primary">Kembalikan</a>
                          </div>
                        </div>
                      </div>
                    </div>