                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="card card-secondary">
                            <div class="card-header">
                                <h2 class="card-title m-0">Data Bimbingan :</h2>
                                    ...
                                    <table id="example8" class="table table-bordered table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div class="btn-group">
                                              <a href="<?= base_url('User_bk/BKSkoringPelanggaran/Detail/'.$key->IDLapor)?>" type="button" class="btn btn-primary"><i class="far fa-list-alt"></i> Detail</a>
                                            </div>
                                            </td>
                                        </tr>
                                        <?php
