<?php
  ...
  if (isset($TampilkanJurnal)&&$TampilkanJurnal!==false) {
    foreach ($TampilkanJurnal as $TK) {
      ...
      $IDGuru=$TK->IDGuru;
      $IDAjaran=$TK->JGM_IDAjaran;
      $IDSemester=$TK->JGM_IDSemester;
      $IDJamPel=$TK->IDJamPel;
      $JamKe=$TK->JamKe;
      $MulaiJampel=$TK->MulaiJampel;
      $AkhirJampel=$TK->AkhirJampel;
      $IDKelas=$TK->IDKelas;
      $KodeKelas=$TK->KodeKelas;
      $IDMapel=$TK->IDMapel;
    ...
    <div class="content-with-overlay">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Edit Jurnal</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Edit</li>
                <li class="breadcrumb-item">Rekapitulasi Jurnal</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="card card-warning">
                          <div class="card-header">
                            <h2 class="card-title m-0">Data Jurnal Guru :</h2>
                            <div class="card-tools">
                              <div class="input-group">
                                <div class="input-group-prepend">
                                  <div class="btn-group">
                                    <a href="<?= base_url('User_pengajar/RekapitulasiJurnal') ?>" class="btn btn-default"><i class="fas fa-backward fa-lg"></i> Kembali</a>
                          ...
                          <!-- /.card-header -->
                          <div class="card-body">
                              <form class="col-md-12" action="<?php echo base_url('User_pengajar');?>/RekapitulasiJurnalCRUD" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                      <div class="form-group">
                                        <label>Tanggal :</label>
                                        <p class="form-control"><?= ubahFormatTanggal($TanggalJurnal) ?></p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
