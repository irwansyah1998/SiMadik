...
<head>
  ...
  <!-- AdminLTE -->
  <script src="<?php echo base_url('assets/template/AdminLTE-master/');?>dist/js/adminlte.js"></script>
  ...
  <style>
    ...
    .bright-overlay {
        ...
        left: 0;
        right: 0;
        background-color: rgba(255, 255, 255, 0.8); /* Ubah kecerahan sesuai preferensi */
        z-index: 1;
    }

    .modal-content {
        /* Ubah kecerahan sesuai preferensi */
        z-index: 1;
    }
