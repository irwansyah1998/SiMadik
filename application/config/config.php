...
|
*/
$config['base_url'] = 'https://localhost/www_sekolah2/';
...
|
*/
$config['encryption_key'] = 'theworldisendwithdestruction';
...
$config['csrf_token_name'] = 'Dattebayou';
$config['csrf_cookie_name'] = 'Narutokun';
